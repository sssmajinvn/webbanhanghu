<?php
// =============================================================
// FILE: ProductModel.php - MODEL XỬ LÝ DỮ LIỆU SẢN PHẨM
// =============================================================
...
class ProductModel
{
    ...
    // READ - Lấy thông tin 1 sản phẩm theo ID
    ...
    // CREATE - Thêm sản phẩm mới (có validation + hình ảnh)
    ...
    // UPDATE - Cập nhật thông tin sản phẩm (có hỗ trợ cập nhật hình ảnh)
